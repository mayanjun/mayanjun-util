...
public final class MimeUtils {
    ...
    private static final Map<String, String> MIME_EXT = new HashMap<String, String>();
    private static final Map<String, String> EXT_MIME = new HashMap<String, String>();
    ...
    private static void add(String mimeType, String extension) {
        ...
        //
        if (!MIME_EXT.containsKey(mimeType)) {
            MIME_EXT.put(mimeType, extension);
        }
        EXT_MIME.put(extension, mimeType);
    }
    ...
    public static boolean hasMimeType(String mimeType) {
        ...
        return MIME_EXT.containsKey(mimeType);
    }
     ...
     */
    public static String guessMimeFromExtension(String extension) {
    ...
    public static boolean hasExtension(String extension) {
        ...
        return EXT_MIME.containsKey(extension);
    }
     ...
     */
    public static String guessExtensionFromMime(String mimeType) {
        if (mimeType == null || mimeType.isEmpty()) {
            return null;
        }
